...
type TrainOwnerID string

func (i TrainOwnerID) TrainOwnerName() string {

	o := map[TrainOwnerID]string{
...
func (i TrainOwnerID) String() string {
	return string(i)
}

type OperatorID string

func (i OperatorID) OperatorName() string {
	o := map[OperatorID]string{
...
type TrainTypeID string

func (i TrainTypeID) TrainType() string {
	t := map[TrainTypeID]string{
...
func (i TrainTypeID) String() string {
	return string(i)
}
...
func (i StationID) StationName() string {
	s := map[StationID]string{
...
func (i StationID) String() string {
	return string(i)
}
...
type RailDirectionID string

func (i RailDirectionID) RailDirectionName() string {
	d := map[RailDirectionID]string{
...
func (i RailDirectionID) String() string {
	return string(i)
}
...
func (i RailWayID) RailWayName() string {
	r := map[RailWayID]string{
...
func (i RailWayID) String() string {
	return string(i)
}
